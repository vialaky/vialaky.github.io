document.addEventListener('DOMContentLoaded', async () => {
  ...
  function showModal(imageSrc, altText) {
    ...
    modal.innerHTML = `
      ...
      <span class="modal-close"><svg viewBox="0 0 24 24" width="24" height="24"><path fill="#1a2a57" d="M18 6L6 18M6 6l12 12" stroke="#1a2a57" stroke-width="2" stroke-linecap="round"/></svg></span>        <img src="${imageSrc}" alt="${altText}" class="modal-image">
      </div>
    `;
